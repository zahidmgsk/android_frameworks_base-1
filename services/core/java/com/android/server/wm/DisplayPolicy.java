...
public class DisplayPolicy {
    ...
    public void onConfigurationChanged() {
        ...
        final int uiMode = mService.mPolicy.getUiMode();
        final boolean showNavbar = CherishUtils.shouldShowGestureNav(mContext);
    ...
    private boolean gestureNavbarHidden() {
        boolean isGestureNavbar = (CherishUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural")
                || CherishUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural_wide_back")
                || CherishUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural_extra_wide_back")
                || CherishUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural_narrow_back"));
